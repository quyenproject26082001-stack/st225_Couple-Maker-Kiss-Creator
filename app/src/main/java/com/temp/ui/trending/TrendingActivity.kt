...
import com.temp.databinding.ActivityTrendingBinding
...
import com.temp.ui.random_character.RandomCharacterViewModel
...
class TrendingActivity : BaseActivity<ActivityTrendingBinding>() {
    ...
    private fun initData() {
        ...
        CoroutineScope(SupervisorJob() + Dispatchers.Main + handleExceptionCoroutine).launch {
            ...
            suspend fun processCharacter(data: com.temp.data.model.custom.CustomizeModel) {
