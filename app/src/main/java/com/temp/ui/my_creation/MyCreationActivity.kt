package com.temp.ui.my_creation
...
import com.temp.core.utils.share.whatsapp.WhatsappSharingActivity
import com.temp.core.utils.state.HandleState
import com.temp.databinding.ActivityAlbumBinding
import com.temp.dialog.YesNoDialog
import com.temp.ui.home.HomeActivity
import com.temp.ui.view.ViewActivity
import com.temp.databinding.PopupMyAlbumBinding
import com.temp.dialog.CreateNameDialog
import com.temp.ui.my_creation.adapter.MyAvatarAdapter
...
class MyCreationActivity : WhatsappSharingActivity<ActivityAlbumBinding>() {
                            ...
                            when (state) {
                                ...
                                HandleState.SUCCESS -> {
                                    ...
                                    if (isInSelectionMode) {
                                        binding.actionBar.btnActionBarLeftText.performClick()
                                    }
                                }
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
            ...
            btnActionBarRight.setImageResource(R.drawable.ic_delete_item)
