...
import com.temp.databinding.ActivityChooseCharacterBinding
...
class ChooseCharacterActivity : BaseActivity<ActivityChooseCharacterBinding>() {
    ...
    private fun checkInternetForAPICharacters(data: ArrayList<com.temp.data.model.custom.CustomizeModel>) {
