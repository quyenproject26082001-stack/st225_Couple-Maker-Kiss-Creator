...
import com.couple.avatar.maker.kisscreator.core.extensions.dLog
import com.couple.avatar.maker.kisscreator.core.extensions.eLog
...
import com.couple.avatar.maker.kisscreator.core.extensions.logEvent
...
import com.couple.avatar.maker.kisscreator.core.extensions.startIntentLeftToRight
...
import com.couple.avatar.maker.kisscreator.databinding.ActivityCustomizeBinding
import com.couple.avatar.maker.kisscreator.dialog.DialogType
...
import com.couple.avatar.maker.kisscreator.ui.add_character.AddCharacterActivity
...
class CustomizeCharacterActivity : BaseActivity<ActivityCustomizeBinding>() {
    ...
    override fun viewListener() {
        binding.apply {
            actionBar.apply {
                ...
                binding.actionBar.btnActionBarRightText.tap(10) {
                    handleSave()
                }
            }
    ...
    override fun initActionBar() {
        binding.actionBar.apply {
            ...
            tvLeftText.select()
            tvRightText.setText(R.string.next)
            tvRightText.select()
    ...
    private fun handleGenderSwitch(gender: Int) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val listToSubmit = viewModel.itemNavList[viewModel.positionNavSelected]
            android.util.Log.d("GenderSwitch", "itemNavList[${viewModel.positionNavSelected}].size=${listToSubmit.size}")
            listToSubmit.forEachIndexed { i, item ->
                val itemType = when (item.path) {
                    com.couple.avatar.maker.kisscreator.core.utils.key.AssetsKey.NONE_LAYER -> "NONE"
                    com.couple.avatar.maker.kisscreator.core.utils.key.AssetsKey.RANDOM_LAYER -> "RANDOM"
                    else -> "IMAGE"
                }
                android.util.Log.d("GenderSwitch", "  item[$i] type=$itemType | isSelected=${item.isSelected} | path=${item.path}")
            }
